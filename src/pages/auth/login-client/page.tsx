        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <div className="w-14 h-14 rounded-2xl bg-accent-100 flex items-center justify-center mx-auto mb-4">
              <i className="ri-user-smile-line text-2xl text-accent-600"></i>
            </div>
          ...
          <div className="bg-background-50 border border-background-200/70 rounded-lg p-6 md:p-8">
            {error && (
              <div className="mb-5 p-3 rounded-md bg-red-50/80 border border-red-100 text-red-700 text-sm flex items-start gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full h-11 px-4 rounded-md border border-background-200/70 bg-background-50 text-sm text-foreground-950 placeholder:text-foreground-400 focus:outline-none focus:border-accent-300 focus:ring-1 focus:ring-accent-300 transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full h-11 px-4 pr-10 rounded-md border border-background-200/70 bg-background-50 text-sm text-foreground-950 placeholder:text-foreground-400 focus:outline-none focus:border-accent-300 focus:ring-1 focus:ring-accent-300 transition-colors"
                  />
                  <button
                    type="button"
            ...
            <div className="mt-6">
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-3 bg-background-50 text-foreground-400">Pas encore de compte ?</span>
                </div>
              </div>
            ...
            <div className="mt-6 pt-5 border-t border-background-200/70 text-center">
              <p className="text-xs text-foreground-400 mb-2">Vous êtes un professionnel ?</p>
              <Link to="/login" className="text-sm text-foreground-600 font-medium hover:text-foreground-950 transition-colors">
